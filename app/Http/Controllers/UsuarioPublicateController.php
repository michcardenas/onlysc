    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $request->validate([
                ...
                'fotos.*' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:3145728',
                'foto_destacada' => 'nullable|file|mimes:jpeg,png,jpg,gif,mp4,webm|max:3145728',
                ...
                'videos.*' => 'nullable|file|mimes:mp4,webm,ogg|max:3145728',
